define([
    ...
    var inline_Tingg = {}; // not used yet - put a few methods on here for the seller to use?
    (function(document){
    ...
    " });
        ...
        onready(function(){
            ...
            var lightbox_iframe = makeElement('iframe', {
                className: 'Tingg_lightbox_iframe',
                name: 'Tingg_lightbox_iframe',
                id: 'Tingg_lightbox_iframe',
                frameborder: '0',
