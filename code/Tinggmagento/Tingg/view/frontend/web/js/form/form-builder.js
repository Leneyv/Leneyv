    ...
    function ($, _, mageTemplate) {
        ...
        return {
            ...
            build: function (formData) {
                var formTmpl = mageTemplate('<form action="<%= data.action %>" id="Tingg_payment_form"' +
            ...
            makeInline: function (form) {
                ...
                var use_inline_input = this.makeElement('input', {
                    name: 'Tingg_use_inline',
                    type: 'hidden',
                    value: '1'
                });
                form.append(use_inline_input);
                if (!is_mobile()) {
                    form.attr('target', 'Tingg_lightbox_iframe');
                } else {
                    var inline_mobile = this.makeElement('input', {
                        name: 'Tingg_inline_mobile',
                        type: 'hidden',
                        value: '1'
                    });
                    form.append(inline_mobile);
                }
            },
