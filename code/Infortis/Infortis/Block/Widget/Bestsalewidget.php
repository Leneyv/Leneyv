...
class Bestsalewidget extends Template implements BlockInterface
{
    //templates in infortis/view/frontend/template/widget 
    protected $_template = "widget/bestsalewidget.phtml";
    ...
    protected $_image_helper;
        ...
        public function getProductCollectionbyIds($prod_ids)
        {
            ...
            $collection->addFieldToFilter('entity_id', ['in', $prod_ids]);   
            return $collection;
        } 
