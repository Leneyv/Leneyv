...
class Featuredprodhg extends Template implements BlockInterface
{
    //templates in infortis/view/frontend/template/widget 
    protected $_template = "widget/featuredprodhg.phtml";
    ...
    protected $_categoryRepository;
        ...
        {
            $imageUrl = $this->_image_helper->init($product, 'items_grid_thumbnails_l')
