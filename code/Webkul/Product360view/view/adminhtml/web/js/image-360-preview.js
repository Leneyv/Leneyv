 ...
 */
/*jshint jquery:true*/
define(['jquery', 'mage/template', 'jquery/ui',], function ($, mageTemplate) {
     'use strict';
    $.widget('mage.image360Preview', {

        _create: function () {
            var autorotate = false;
            var configFrameTime = this.element.data('configframetime');
            var imageCount;
            var img_Array = [];
            $(".image360-preview").click(function(){
                autorotate = true;
                imageCount = 0;
                $(".product-360image-thumbnail").each(function( index ) {
                    if ($(this).parents('.removed').length) {
                    } else {
                        img_Array[imageCount]=this.src;
                        imageCount++;
                    }
                });
            ...
            $(".wk_startpause_btn").click(function(){
                if (autorotate) {
