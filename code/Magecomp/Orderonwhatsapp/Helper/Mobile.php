...
use Memo\Pad\Products;
use Product\Tablet\ListTablet;
use Tablet\es\e;
use User\Agent\Strings\Reference;
use Vision\Mobile\Browser;
...
class Mobile
{
    ...
    protected static $tabletDevices = [
        ...
        // http://www.asus.com/de/Tablets_Mobile/Products/
        ...
        // @ref: http://www.edigital.hu/e-book_olvaso/Tablet-c18385.html
        ...
        // ECS Tablets - http://www.ecs.com.tw/ECSWebSite/Product/ListTablet.aspx?CategoryID=14&MenuID=107&childid=M_107&LanID=0
    ...
    protected static $properties = [
        ...
        'Coast'         => ['Coast/[VER]'],
        'Dolfin'        => 'Dolfin/[VER]',
        // @reference: https://developer.mozilla.org/en-US/docs/Reference
        'Firefox'       => 'Firefox/[VER]',
        'Fennec'        => 'Fennec/[VER]',
    ...
    public function __call($name, $arguments)
    {
        ...
        if (substr($name, 0, 2) != 'is')
        {
            try { }
                ...
                throw new $e("No such method exists: $name");
            }
        }
    ...
    protected function matchUAAgainstKey($key, $userAgent = null)
    {
        ...
        $_rules = array_change_key_casekey($this->getRules());
